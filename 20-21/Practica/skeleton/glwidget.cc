...
_gl_widget::_gl_widget(_window *Window1):Window(Window1), \
            Model(ply_object("../skeleton/ply_models/happy.ply"))
{
...
void _gl_widget::keyPressEvent(QKeyEvent *Keyevent)
{
  ...
  case Qt::Key_6:Object=OBJECT_MODEL;break;
...
void _gl_widget::draw_objects()
{
  ...
  if (Draw_point){
    ...
    case OBJECT_MODEL:Model.draw_point();break;
    default:break;
    }
  }
  ...
  if (Draw_line){
    ...
    case OBJECT_MODEL:Model.draw_line();break;
    default:break;
    }
  }
  ...
  if (Draw_fill){
    ...
    case OBJECT_MODEL:Model.draw_fill();break;
    default:break;
    }
  }
  ...
  if (Draw_chess){
    ...
    case OBJECT_MODEL:Model.draw_chess();break;
    default:break;
    }
  }
}
